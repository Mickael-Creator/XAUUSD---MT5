...
class NewsTradingAnalyzer:
    ...
    def generate_signal(
        ...
        # ═══════════════════════════════════════════════════════════
        # 5. ANALYZE SURPRISE (if post-news)
        # ═══════════════════════════════════════════════════════════
        ...
        # ═══════════════════════════════════════════════════════════
        # 6. COMBINE BIASES → ENTRY DECISION
        # ═══════════════════════════════════════════════════════════
        ...
        # COT has highest weight (institutional positioning)
        if cot_bias == "BULLISH":
            bias_scores['BULLISH'] += 35
        elif cot_bias == "BEARISH":
            bias_scores['BEARISH'] += 35
